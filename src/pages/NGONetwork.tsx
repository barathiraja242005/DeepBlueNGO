    ...
    <div className="h-screen overflow-y-auto bg-background p-8">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <MapPin className="h-8 w-8 text-[#0F2854]" />
              <div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <CheckCircle className="h-8 w-8 text-[#0F2854]" />
              <div>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#BDE8F5] via-[#4988C4] to-[#1C4D8D] flex items-center justify-center flex-shrink-0 shadow-lg transform hover:rotate-12 transition-transform">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {ngo.focus.map((focus, idx) => {
                    const colors = [
                      ...
                      'from-[#4988C4] via-[#4988C4] to-[#0F2854]'
                    ];
                    return (
                      <span 
                        key={focus} 
