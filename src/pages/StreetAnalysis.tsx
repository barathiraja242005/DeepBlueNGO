            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex gap-3">
                ...
                <motion.button
                  ...
                  className="px-4 py-2.5 bg-gradient-to-r from-[#4988C4] to-[#1C4D8D] text-white rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center gap-2 font-semibold"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-4 mb-3">
                ...
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-[#4988C4] to-[#1C4D8D] bg-clip-text text-transparent">{totalStreets}</p>
            ...
            >
              <div className="absolute top-0 right-0 w-28 h-28 opacity-10">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-[#1C4D8D] via-[#0F2854] to-[#4988C4] blur-2xl" />
              </div>
              <div className="relative z-10 flex items-center gap-4 mb-3">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#1C4D8D] via-[#0F2854] to-[#4988C4] flex items-center justify-center shadow-xl transform hover:rotate-12 transition-transform">
                  <AlertCircle className="h-6 w-6 text-white" />
                </div>
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-[#0F2854] to-[#1C4D8D] bg-clip-text text-transparent">{emergencyStreets}</p>
            ...
            >
              <div className="absolute top-0 right-0 w-28 h-28 opacity-10">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-[#4988C4] to-[#1C4D8D] blur-2xl" />
              </div>
              <div className="relative z-10 flex items-center gap-4 mb-3">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#4988C4] to-[#1C4D8D] flex items-center justify-center shadow-xl transform hover:rotate-12 transition-transform">
                  <Activity className="h-6 w-6 text-white" />
                </div>
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-[#1C4D8D] to-[#4988C4] bg-clip-text text-transparent">{doctorStreets}</p>
            ...
            >
              <div className="absolute top-0 right-0 w-28 h-28 opacity-10">
                <div className="w-full h-full rounded-full bg-gradient-to-br from-[#1C4D8D] to-[#0F2854] blur-2xl" />
              </div>
              <div className="relative z-10 flex items-center gap-4 mb-3">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#1C4D8D] to-[#0F2854] flex items-center justify-center shadow-xl transform hover:rotate-12 transition-transform">
                  <TrendingUp className="h-6 w-6 text-white" />
                </div>
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-[#0F2854] to-[#1C4D8D] bg-clip-text text-transparent">{totalCases.toLocaleString()}</p>
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-4 mb-3">
                ...
                <div>
                  <p className="text-4xl font-black bg-gradient-to-r from-[#1C4D8D] to-[#0F2854] bg-clip-text text-transparent">{avgCasesPerStreet}</p>
          ...
          >
            ...
            <div className="space-y-3">
              {diseaseCount.map(([disease, count], index) => {
                ...
                const colors = ['bg-[#0F2854]', 'bg-[#1C4D8D]', 'bg-[#4988C4]', 'bg-[#BDE8F5]', 'bg-[#1C4D8D]'];
                return (
                  <motion.div
                    key={disease}
              ...
              {searchTags.length > 0 && (
                ...
                >
                  {searchTags.map((tag, index) => {
                    const colors = {
                      street: 'bg-[#4988C4]/10 text-[#0F2854] border-[#4988C4] hover:bg-[#4988C4]/20',
                  ...
                  >
                    <div className="p-2">
                      ...
                      {suggestions.map((suggestion, index) => {
                        const colors = {
                          street: 'hover:bg-blue-500/10 border-l-blue-500',
                          city: 'hover:bg-green-500/10 border-l-green-500',
                          state: 'hover:bg-purple-500/10 border-l-purple-500'
                        };
                        const iconEmoji = {
                          street: '🛣️',
                          city: '🏙️',
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex flex-col items-end gap-1 bg-gradient-to-br from-[#1C4D8D] to-[#0F2854] rounded-xl px-4 py-3 shadow-lg">
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-4">
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-xs font-bold text-[#0F2854]">{street.emergencyIncidents}</span>
                          </div>
                          <div className="w-full h-2 bg-[#BDE8F5]/30 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-gradient-to-r from-[#0F2854] to-[#1C4D8D] rounded-full"
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-xs font-bold text-[#1C4D8D]">{street.doctorIncidents}</span>
                          </div>
                          <div className="w-full h-2 bg-[#BDE8F5]/30 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-gradient-to-r from-[#1C4D8D] to-[#4988C4] rounded-full"
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-xs font-bold text-[#4988C4]">{street.selfCareIncidents}</span>
                          </div>
                          <div className="w-full h-2 bg-[#BDE8F5]/30 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-gradient-to-r from-[#4988C4] to-[#BDE8F5] rounded-full"
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4">
                        <div className="text-center p-3 rounded-xl bg-gradient-to-br from-[#BDE8F5]/50 to-[#BDE8F5]/20 border-2 border-[#4988C4]/30">
                          <p className="text-lg font-bold text-[#0F2854]">{street.diseases.length}</p>
                          <p className="text-xs text-[#1C4D8D] font-medium">Diseases</p>
                        </div>
                        <div className="text-center p-3 rounded-xl bg-gradient-to-br from-[#4988C4]/30 to-[#4988C4]/10 border-2 border-[#1C4D8D]/30">
                          <p className="text-lg font-bold text-[#0F2854]">{street.incidents.length}</p>
                          <p className="text-xs text-[#1C4D8D] font-medium">Incidents</p>
                        </div>
                        <div className="text-center p-3 rounded-xl bg-gradient-to-br from-[#1C4D8D]/30 to-[#1C4D8D]/10 border-2 border-[#0F2854]/30">
                          <p className="text-xs font-bold text-[#0F2854]">{new Date(street.lastReported).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</p>
                          <p className="text-xs text-[#1C4D8D] font-medium">Last Report</p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {street.diseases.length > 3 && (
                          <span className="px-3 py-1.5 bg-[#BDE8F5] text-[#0F2854] text-xs font-bold rounded-xl border-2 border-[#4988C4]/50">
